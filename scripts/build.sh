...
apollo_config_db_url=jdbc:mysql://212.64.51.173:3250/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=aI&9x$nYc7o#8f

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://212.64.51.173:3250/ApolloPortalDB?characterEncoding=utf8
apollo_portal_db_username=root
apollo_portal_db_password=aI&9x$nYc7o#8f

# meta server url, different environments should have different meta server addresses
dev_meta=http://212.64.51.173:9999
